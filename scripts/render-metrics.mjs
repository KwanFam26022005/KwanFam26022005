...
const accents = ['#58a6ff', '#468ec9', '#3777a8', '#2a6087', '#1f4c6e'];
...
const languageRows = langs.map(([name, count], i) => {
  ...
  <rect x="218" y="${y - 8}" width="155" height="5" rx="2.5" fill="#0d243a"/>
...
<style>
  ...
  .title { font-family: ${FONT_SANS}; font-size: 17px; font-weight: 700; fill: #ffffff; }
  .stat { font-family: ${FONT_MONO}; font-size: 13px; font-weight: 700; fill: #f0f6fc; }
  .muted { font-family: ${FONT_MONO}; font-size: 9.5px; fill: #719ec2; }
  .key { font-family: ${FONT_MONO}; font-size: 10.5px; fill: #b8d4eb; }
  .date { font-family: ${FONT_MONO}; font-size: 10px; fill: #6e99bd; }
  .repo { font-family: ${FONT_MONO}; font-size: 10.5px; fill: #e2edf7; }
</style>
<rect width="960" height="280" rx="18" fill="#040c16"/>
<rect x="12" y="12" width="936" height="256" rx="14" fill="#0b1b2d" stroke="#22486e" stroke-width="1.2"/>
<text x="30" y="36" class="mono prompt">khoa@github:~$ ./profile --activity</text>
<rect x="254" y="26" width="6" height="12" rx="1" fill="#79c0ff"><animate attributeName="opacity" values="1;.12;1" dur="1.15s" repeatCount="indefinite"/></rect>
