...
const accents = ['#0969da', '#2563eb', '#3b82f6', '#60a5fa', '#93c5fd'];
...
const languageRows = langs.map(([name, count], i) => {
  ...
  <rect x="218" y="${y - 8}" width="155" height="5" rx="2.5" fill="#e2e8f0"/>
...
<style>
  ...
  .title { font-family: ${FONT_SANS}; font-size: 17px; font-weight: 700; fill: #0f172a; }
  .stat { font-family: ${FONT_MONO}; font-size: 13px; font-weight: 700; fill: #0f172a; }
  .muted { font-family: ${FONT_MONO}; font-size: 9.5px; fill: #64748b; }
  .key { font-family: ${FONT_MONO}; font-size: 10.5px; fill: #334155; font-weight: 500; }
  .date { font-family: ${FONT_MONO}; font-size: 10px; fill: #64748b; }
  .repo { font-family: ${FONT_MONO}; font-size: 10.5px; fill: #0f172a; }
</style>
<rect width="960" height="280" rx="14" fill="#ffffff" stroke="#d0d7de" stroke-width="1.2"/>
<rect x="12" y="12" width="936" height="256" rx="10" fill="#f8fafc" stroke="#d0d7de" stroke-width="1"/>
<text x="30" y="36" class="mono prompt">khoa@github:~$ ./profile --activity</text>
<rect x="254" y="26" width="6" height="12" rx="1" fill="#0969da"><animate attributeName="opacity" values="1;.12;1" dur="1.15s" repeatCount="indefinite"/></rect>
