...
for (let i = 0; i < days.length; i++) {
  ...
  if (month !== lastMonth && d.getUTCDate() <= 7) {
    const offset = i + startDow;
    const week = Math.floor(offset / 7);
    monthLabels.push(`<text x="${padX + week * step}" y="63" class="month">${month}</text>`);
    lastMonth = month;
  }
}
...
<style>
  ...
  .prompt{font-size:11px;fill:#78a8c4}
  .title{font-size:17px;font-weight:700;fill:#f8fafc}
  .month{font:9px ui-monospace,SFMono-Regular,Menlo,monospace;fill:#55788f}
  .day{font:9px ui-monospace,SFMono-Regular,Menlo,monospace;fill:#55788f}
  .small{font:9px ui-monospace,SFMono-Regular,Menlo,monospace;fill:#55788f}
</style>
<rect width="${width}" height="${height}" rx="18" fill="#06111f"/>
<rect x="12" y="12" width="936" height="200" rx="14" fill="#081829" stroke="#153a55"/>
...
<text x="30" y="59" class="mono title">Contribution signal</text>
...
${rects}
<g transform="translate(725 194)" class="mono small">
