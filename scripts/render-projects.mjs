...
<style>
  ...
  .lane{font-size:13px;font-weight:700;letter-spacing:.8px}
  .sub{font-size:10.5px;fill:#64859b}
  .repo{font:650 12px -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;fill:#eef8ff}
  .desc{font:10.5px -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;fill:#88a5b8}
  .tag{font:700 9px ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.6px;text-anchor:end}
</style>
